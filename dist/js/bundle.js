...
/***/ "./src/js/parts/bigImg.js":
/*!********************************!*\
  !*** ./src/js/parts/bigImg.js ***!
  \********************************/
/*! exports provided: bigImg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bigImg", function() { return bigImg; });
/* harmony import */ var _parts_eventDefault__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../parts/eventDefault */ "./src/js/parts/eventDefault.js");


var bigImg = function bigImg() {
  //big_img
  var smallImg = document.querySelectorAll('.works a'),
      div = document.createElement('div'),
      bigImg = document.createElement('img');
  smallImg.forEach(function (item) {
    item.addEventListener('click', function () {
      Object(_parts_eventDefault__WEBPACK_IMPORTED_MODULE_0__["eDefault"])(true);
  ...
  document.body.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains('img-overlay')) {
      ...
      Object(_parts_eventDefault__WEBPACK_IMPORTED_MODULE_0__["eDefault"])(false);
    }
  });
};
...
/*!******************************!*\
  !*** ./src/js/parts/calc.js ***!
  \******************************/
/*! exports provided: calc, a, width, height */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _parts_tabfunction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../parts/tabfunction */ "./src/js/parts/tabfunction.js");
...
var calc = function calc() {
  var windowHeader = document.querySelectorAll('.balcon_icons a'),
  ...
  Object(_parts_tabfunction__WEBPACK_IMPORTED_MODULE_0__["tab"])(windowHeader, windowBlock, "active", "inline-block", true, a);
  ...
  var onlyOneSelect = function onlyOneSelect(first, second) {
...
/***/ "./src/js/parts/eventDefault.js":
/*!**************************************!*\
  !*** ./src/js/parts/eventDefault.js ***!
  \**************************************/
/*! exports provided: eDefault */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eDefault", function() { return eDefault; });
var eDefault = function eDefault(boolean, e) {
  if (e == undefined) {
...
var forms = function forms() {
  ...
  document.querySelectorAll('form').forEach(function (item) {
    item.addEventListener('submit', function () {
      if (item.classList.contains('calc-form')) {
        sent(_parts_calc__WEBPACK_IMPORTED_MODULE_1__["a"]);
      } else {
        possted(this);
      }
    });
  ...
  var possted = function possted(a) {
    var formData = new FormData(a),
        json = {}; // we take information from users and create object for backend part
  ...
  var sent = function sent(json) {
    Object(_parts_eventDefault__WEBPACK_IMPORTED_MODULE_0__["eDefault"])(true); //event default
...
var popups = function popups() {
  ...
  var showOrClose = function showOrClose(popupEngineerStatus, popupStatus, calcPopupStatus, calcPopupSecondStatus, calcPopupFinalStatus, overflowStatus) {
  ...
  document.body.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains('popup_calc_button')) {
      ...
      if (_parts_calc__WEBPACK_IMPORTED_MODULE_1__["width"].value !== '' && _parts_calc__WEBPACK_IMPORTED_MODULE_1__["height"].value !== '') {
    ...
    if (target && target.classList.contains('popup_engineer') || target.classList.contains('popup') || target.classList.contains('popup_calc') || target.classList.contains('popup_calc_profile') || target.classList.contains('popup_calc_end')) {
      Object(_parts_eventDefault__WEBPACK_IMPORTED_MODULE_0__["eDefault"])(false);
...
var tabProject = function tabProject() {
  //tabs 
  var d = document,
  ...
  Object(_parts_tabfunction__WEBPACK_IMPORTED_MODULE_0__["tab"])(firstTabHeader, firstTabBlock, "active", "block");
  Object(_parts_tabfunction__WEBPACK_IMPORTED_MODULE_0__["tab"])(secondTabsHeader, secondTabBlock, "after_click", "block");
};
...
var tab = function tab(header, block, activeClass, displayStyle, attribute, obj) {
  if (attribute !== undefined && attribute == true && obj !== undefined) {
    obj.type = block[0].getAttribute('id'); // if not selected
  }

  var tabsArr = Array.prototype.slice.call(header); //in NodeList we can't use indexOf and for solution we convert NodeList to array

  tabsArr.forEach(function (item) {
  ...
  tabsArr.forEach(function (item) {
    item.addEventListener('click', function () {
      // regular function because we got keyword "this"
      Object(_parts_eventDefault__WEBPACK_IMPORTED_MODULE_0__["eDefault"])(true); // optional!!!

      tabsArr.forEach(function (option) {
...
/* harmony import */ var _parts_popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parts/popups */ "./src/js/parts/popups.js");
/* harmony import */ var _parts_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parts/forms */ "./src/js/parts/forms.js");
/* harmony import */ var _parts_calc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parts/calc */ "./src/js/parts/calc.js");
/* harmony import */ var _parts_bigImg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./parts/bigImg */ "./src/js/parts/bigImg.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_parts_tab__WEBPACK_IMPORTED_MODULE_0__["tabProject"])();
  Object(_parts_popups__WEBPACK_IMPORTED_MODULE_1__["popups"])();
  Object(_parts_forms__WEBPACK_IMPORTED_MODULE_2__["forms"])();
  Object(_parts_calc__WEBPACK_IMPORTED_MODULE_3__["calc"])();
  Object(_parts_bigImg__WEBPACK_IMPORTED_MODULE_4__["bigImg"])();
});
